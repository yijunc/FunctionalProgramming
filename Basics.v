...
Definition orb1 (b1:bool) (b2:bool) :bool :=
  match b2 with
  | true => true
  | false => b1
  end.
...
Definition orb2 (b1:bool) (b2:bool) : bool :=
  negb(andb(negb b1)(negb b2)).

Definition orb3 (b1 b2 : bool) : bool :=   
  match b1, b2 with
  | false, false => false
  | _,_ => true
  end.
...
Example test_orb11:  (orb1 true  false) = true.
Proof. simpl. reflexivity.  Qed.
Example test_orb12:  (orb1 false false) = false.
Proof. simpl. reflexivity.  Qed.
Example test_orb13:  (orb1 false true)  = true.
Proof. simpl. reflexivity.  Qed.
Example test_orb14:  (orb1 true  true)  = true.
Proof. simpl. reflexivity.  Qed.


Example test_orb21:  (orb2 true  false) = true.
Proof. simpl. reflexivity.  Qed.
Example test_orb22:  (orb2 false false) = false.
Proof. simpl. reflexivity.  Qed.
Example test_orb23:  (orb2 false true)  = true.
Proof. simpl. reflexivity.  Qed.
Example test_orb24:  (orb2 true  true)  = true.
Proof. unfold orb2. simpl. reflexivity.  Qed.

Example test_orb131:  (orb3 true  false) = true.
Proof. simpl. reflexivity.  Qed.
Example test_orb32:  (orb3 false false) = false.
Proof. simpl. reflexivity.  Qed.
Example test_orb33:  (orb3 false true)  = true.
Proof. simpl. reflexivity.  Qed.
Example test_orb34:  (orb3 true  true)  = true.
Proof. simpl. reflexivity.  Qed.
