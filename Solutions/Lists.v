...
(*Exercises 2018/10/26*)
Fixpoint ismember (n: nat) (l : natlist) : bool :=
  match l with
   | nil => false
   | m :: l' => orb (beq_nat n m) (ismember n l')
  end.

Example ismember_test1 :
  ismember 1 [2;1;3] = true.
Proof. reflexivity. Qed.

Example ismember_test2 :
  ismember 4 [2;1;3] = false.
Proof. reflexivity. Qed.
...
Fixpoint remove_one (n:nat)(l:natlist) : natlist :=
  ...
  | m :: l' => match (beq_nat n m) with
               | true => l'
               | false => m :: (remove_one n l')
               end
  end.

Example test_remove1 : remove_one 1 [2;1;3;1;4;1] = [2;3;1;4;1].
  Proof. reflexivity. Qed.
...
(* Find the first element of l that is less than or equal to n and 
insert n in front of it. *)
...
Fixpoint summation (l : natlist) : nat :=
  match l with 
  | nil => O
  | h :: t =>  h + summation t
  end.
 
Compute (summation [1;2;3]).
(* ----------------------------------------------------------------- *)
...
Example test_count'1:              count' 1 [1;2;3;1;4;1] = 3.
 (* FILL IN HERE *)
Proof. reflexivity. Qed.
Example test_count'2:              count' 6 [1;2;3;1;4;1] = 0.
 (* FILL IN HERE *) 
Proof. reflexivity. Qed.
...
Fixpoint remove_one_bag (v:nat) (s:bag) : bag :=
  (* REPLACE THIS LINE WITH ":= _your_definition_ ." *)
  match s with
  | nil => nil
  | h :: t => match (beq_nat v h) with
               | true => t
               | false => h :: (remove_one_bag v t)
               end
  end.

Example test_remove_one1:
  count 5 (remove_one_bag 5 [2;1;5;4;1]) = 0.
  (* FILL IN HERE *) 
Proof. reflexivity. Qed.

Example test_remove_one2:
  count 5 (remove_one_bag 5 [2;1;4;1]) = 0.
  (* FILL IN HERE *) 
Proof. reflexivity. Qed.

Example test_remove_one3:
  count 4 (remove_one_bag 5 [2;1;4;5;1;4]) = 2.
  (* FILL IN HERE *) 
Proof. reflexivity. Qed.

Example test_remove_one4:
  count 5 (remove_one_bag 5 [2;1;5;4;5;1;4]) = 1.
  (* FILL IN HERE *)
Proof. reflexivity. Qed.
...
Proof.
  (* FILL IN HERE *) 
Proof. intros l1 l2 l3 l4. induction l1 as [| h t IHt].
...
Fixpoint beq_natlist' (l1 l2 : natlist) : bool :=
  ...
  | _ :: _ , nil => false
  | h :: t, h' :: t' => 
           andb (beq_nat h h') (beq_natlist t t')
  end.
...
Proof. induction l as [| h t IHt].
 - reflexivity. 
 - simpl. rewrite beq_ref. rewrite <- IHt. reflexivity.
Qed.
(** [] *)
...
Proof. 
  (* FILL IN HERE *) intro x. destruct x. simpl. 
   rewrite <- beq_nat_refl. reflexivity.
Qed.
(** [] *)
