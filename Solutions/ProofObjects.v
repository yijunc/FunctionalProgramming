...
Theorem conj_fact_thm : forall P Q R, P /\ Q -> Q /\ R -> P /\ R.
Proof. intros P Q R [HP HQ] [_ HR].
...
Theorem or_comm_thm : forall P Q, P \/ Q -> Q \/ P.
...
Theorem ex_ev_Sn_thm : exists n, ev (S n).
Proof. exists 1. apply ev_SS. apply ev_0. Show Proof. Qed.
...
Proof.
(* FILL IN HERE *) 
  intros X x y H P Hx. rewrite H in Hx. apply Hx.
Qed.
