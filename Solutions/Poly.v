...
Compute (repeat bool false 2).
Compute (repeat nat 3 2).

Compute (repeat (list nat) ( cons nat 1 (cons nat 3 (nil nat)) ) 2).
...
Theorem app_nil_r : forall (X:Type), forall l:list X,
  l ++ [] = l.
Proof. intros X l. induction l as [| t h IHh].
 - reflexivity.
...
Proof.
 ...
 - reflexivity.
 - simpl. rewrite <- IHt. rewrite map_distr. reflexivity.
Qed.
...
Proof. intros X l. induction l as [| h t IHt].
  ...
  - unfold fold_length. simpl. unfold fold_length in IHt. rewrite IHt. reflexivity.
Qed.
(** [] *)
...
Proof. intros X Y f l. induction l as [| h t IHt].
  - reflexivity. 
  - unfold fold_map. simpl. rewrite <- IHt. unfold fold_map.
...
Proof.
  (* FILL IN HERE *) 
  intros X Y Z f x y. unfold prod_curry. unfold prod_uncurry. reflexivity.
Qed.

Lemma surjective_pairing : forall (X Y : Type) (p : X * Y), 
  (fst p, snd p) = p.
Proof. destruct p as [p1 p2]. reflexivity. Qed.
...
Proof.
  (* FILL IN HERE *) 
  intros X Y Z f p. unfold prod_uncurry. unfold prod_curry. 
...
Proof. (* FILL IN HERE *) 
  unfold zero. unfold succ. unfold one. reflexivity.
Qed.

Example succ_2 : succ one = two.
Proof. (* FILL IN HERE *) 
  unfold one; unfold succ; unfold two. reflexivity.
Qed.


Example succ_3 : succ two = three.
Proof. (* FILL IN HERE *) 
  unfold two; unfold succ; unfold three. reflexivity.
Qed.
...
Proof. (* FILL IN HERE *) 
  unfold plus; unfold zero; unfold one. reflexivity.
Qed.


Example plus_2 : plus two three = plus three two.
Proof. (* FILL IN HERE *) 
  unfold plus; unfold two; unfold three;
...
Proof. (* FILL IN HERE *)
  unfold plus; unfold two; unfold three; unfold one;
  unfold doit3times. reflexivity.
Qed.
...
Proof. (* FILL IN HERE *) 
  unfold mult; unfold zero; unfold plus; unfold three; unfold doit3times.
  reflexivity.
Qed.

Example mult_3 : mult two three = plus three three.
Proof. (* FILL IN HERE *) 
  unfold mult; unfold two; unfold three; unfold doit3times; unfold plus.
  reflexivity.
Qed.
...
Proof. (* FILL IN HERE *) 
  unfold exp; unfold three; unfold doit3times; unfold plus; unfold mult;
  unfold two; unfold one; reflexivity.
Qed.


Example exp_3 : exp three zero = one.
Proof. (* FILL IN HERE *) 
  unfold exp; unfold three; unfold doit3times; unfold zero; unfold one; reflexivity.
Qed.
