...
Theorem geb_eq: forall n : nat, leb 0 n = true.
Proof. intro n.  simpl. reflexivity. Qed.
...
Example test_Ack1 : Ackermann 2 10 = 23.
Proof. simpl. reflexivity. Qed.
(** [] *)
...
Theorem negation_fn_applied_twice :
  ...
  forall (b : bool), f (f b) = b.
Proof. intros f H b. rewrite H. rewrite H. rewrite negb_involutive. reflexivity.
Qed.
...
Example test1: incr (incr (incr zero)) = incr (twice (twice_plus_1 zero)).
Proof. simpl. reflexivity. Qed.

Example test2: bin_to_nat (incr (twice (twice_plus_1 zero))) = S (S (S O)).
Proof. simpl. reflexivity. Qed. 
